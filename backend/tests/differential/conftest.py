...
def tsref() -> dict[str, Path]:
    ...
    return {
        ...
        "autostore": TSREF / "autostore.mjs", "fabricwiring": TSREF / "fabricwiring.mjs", "runtypes": TSREF / "runtypes.mjs", "wfengine": TSREF / "wfengine.mjs", "autoengine": TSREF / "autoengine.mjs", "dryrun": TSREF / "dryrun.mjs",
    }
