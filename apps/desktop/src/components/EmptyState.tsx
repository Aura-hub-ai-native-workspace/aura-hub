...
/**
 * EmptyState — the honest placeholder. Shown wherever real data does not
 * exist yet. AURA never fabricates content, so an empty surface says so
 * plainly and points at the action that would fill it.
 */
