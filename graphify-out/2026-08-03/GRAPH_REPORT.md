# Graph Report - aura-hub  (2026-08-02)

## Corpus Check
- 459 files · ~448,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4190 nodes · 10234 edges · 188 communities (175 shown, 13 thin omitted)
...
- `SummaryChip()` --calls--> `cn()`  [EXTRACTED]
  apps/desktop/src/ops/AgentCenter.tsx → packages/core/src/utils/cn.ts
...
Cohesion: 0.11
Nodes (26): buildUserPrompt(), compareCandidates(), DiagnosisComparison, generateTaskProposal(), languageForPath(), TaskGenResult, MissionGoal, TaskProposal (+18 more)

### Community 1 - "Project Workspace Sections"
Cohesion: 0.07
Nodes (48): ArchitectureLayer, ProjectIntelligence, WorkspaceIntelligence, ArchitectureDiagram3D(), DEFAULT_LAYERS, LayerDef, Card, CardHeader() (+40 more)

### Community 2 - "Conversations & Intent"
Cohesion: 0.09
Nodes (29): IntentClassifier, KeywordIntentClassifier, PromptEnhancer, TemplatePromptEnhancer, Attachment, Citation, ContextKind, ContextSource (+21 more)

### Community 3 - "Repository Intelligence Modules"
Cohesion: 0.09
Nodes (52): FileContent, fileExists(), getDirectoryTree(), getFileInfo(), getProjectInfo(), listFiles(), ProjectInfo, searchCode() (+44 more)
...
Cohesion: 0.10
Nodes (24): AgentCenter(), AgentView, ApprovalCard(), CampaignCard(), SEVERITY_TONE, STATUS_META, SummaryChip(), TimelineView() (+16 more)

### Community 7 - "App Shell & Store"
Cohesion: 0.11
Nodes (14): ExtractorRegistry, FileRecord, normPath(), RelationLinker, FullStackEngineOptions, FullStackKnowledgeEngine, LAYER_CATEGORY, abortError() (+6 more)
...
Cohesion: 0.07
Nodes (9): PatchCandidate, RunReadyOptions, MissionEvent, Conversation, ConversationSummary, MemoryItem, MemoryKind, PipelineOptions (+1 more)

### Community 10 - "Home & Projects Screens"
Cohesion: 0.17
Nodes (19): SearchScope, openDiagnosis(), openMission(), openProjectShell(), qMatch(), runSearch(), SEARCH_SCOPE_META, searchArchitecture() (+11 more)
...
Cohesion: 0.09
Nodes (23): diagnosisClient, Badge(), VirtualList(), NotificationCenter(), NotificationRow(), AuraNotification, NOTIFICATION_KIND_META, NotificationInput (+15 more)

### Community 13 - "Intelligence Types"
Cohesion: 0.14
Nodes (27): AgentContext, ConfidenceSource, AssembledContext, ContextAssemblerInput, detectDocKind(), INTENT_DOC_PRIORITIES, prioritizeDocuments(), IntelligenceEngineResult (+19 more)
...
Cohesion: 0.08
Nodes (19): ConversationSummary, InspectResult, StreamDone, StreamError, AiMarkdown(), inline(), AiWorkspace(), errorTitle() (+11 more)
...
Cohesion: 0.13
Nodes (23): DEFAULT_STORE, deriveKey(), getActive(), getAllProviderStores(), getFingerprint(), getKey(), isConnected(), load() (+15 more)
...
Cohesion: 0.09
Nodes (27): IndexStatus, Mount, buildProfile(), classify(), DB_DEPS, deriveBuildSystem(), deriveCodingStyle(), deriveEntryPoints() (+19 more)
...
Cohesion: 0.30
Nodes (6): setCheckpoint(), activity(), MissionExecutionEngine, timeline(), computeMetrics(), MissionRecord

### Community 34 - "Project Memory & Graph"
Cohesion: 0.04
Nodes (87): AuraLockup(), AuraLogo(), AuraLogoProps, AuraTile(), BadgeProps, TONES, ButtonProps, ButtonSize (+79 more)

### Community 35 - "Navigation & App Store"
Cohesion: 0.06
Nodes (59): ActionKind, CodeActionResponse, GraphEntity, RiskLevel, ACTION_SPECS, actionSpec, WorkspaceActionId, AIActionDialog() (+51 more)
...
Cohesion: 0.05
Nodes (62): aiClient, AiSettings, CodeActionFinding, CodeActionRequest, ConnectedProvider, Conversation, ConvMessage, ENV (+54 more)
...
Cohesion: 0.09
Nodes (40): CHECKPOINT_LABELS, CHECKPOINT_ORDER, checkpointStatus(), emptyCheckpoints(), nextCheckpoint(), statusFromCheckpoints(), buildDag(), DagInput (+32 more)
...
Cohesion: 0.13
Nodes (11): MODE_EXPANSIONS, FileKind, LanguageId, FileRecord, KnowledgeStore, editDistance(), ExpansionKind, InvertedIndex (+3 more)
...
Cohesion: 0.06
Nodes (57): check(), main(), AutomationEngine, AutomationEngineOptions, coerceNumber(), evaluateCondition(), evaluateConditions(), getPath() (+49 more)

### Community 46 - "context.ts"
Cohesion: 0.12
Nodes (14): ContextBuilder, CodingKnowledgeEngine, CodingSearch, CodingContext, CodingContextEntry, ContextChunkRef, ContextOptions, IndexPhase (+6 more)
...
Cohesion: 0.31
Nodes (9): buildSystemPrompt(), buildUserPrompt(), clampLine(), generatePatch(), numberedLines(), PatchGenResult, STRATEGY_PROMPT, PatchStrategy (+1 more)
...
Cohesion: 0.12
Nodes (19): CheckpointStatus, ExecutionDag, ExecutionTaskStatus, MissionCategory, MissionReplayPayload, TaskKind, TaskPriority, TaskRisk (+11 more)
...
Cohesion: 0.17
Nodes (20): CallSite, detectBrokenApi(), findCallSites(), findRealCallers(), detectDeadCode(), NEVER_ELIGIBLE_KINDS, scanExports(), scanImportedNames() (+12 more)
...
Cohesion: 0.12
Nodes (19): classify(), now(), runDiagnosis(), STRATEGIES, generateRootCause(), DiagnosisStore, fileOf(), DiagnosisEvent (+11 more)
...
Cohesion: 0.07
Nodes (24): ApiKeyInput(), KeyStatus, AuraGlyphField(), NODES, AuroraBackground(), detectProviderId(), RULES, OnboardingFlow() (+16 more)
...
Cohesion: 0.08
Nodes (33): ArchitectureFinding, Finding, DebtCategory, DebtItem, DebtThresholds, DEFAULT_DEBT_THRESHOLDS, summarizeDebt(), DocIssue (+25 more)
...
Cohesion: 0.17
Nodes (11): OpenAICompatibleRuntime, ModelCapabilities, GenerateRequest, GenerateResponse, HealthStatus, HealthStatusType, ModelInfo, RuntimeConfig (+3 more)

### Community 89 - "Community 89"
Cohesion: 0.21
Nodes (8): captureFrame(), MissionExecution, fileOf(), hydrate(), hydrationEngine, MissionStore, MissionSummary, genId()

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (23): governanceClient, CacheEntry, createGovernanceEngine(), GovernanceEngine, GovernanceEngineOptions, ReportName, ArchitectureHealthReport, ArchitectureInput (+15 more)
...
Cohesion: 0.07
Nodes (41): CodeRelationRef, BugCategory, Classification, CompilerDiagnostic, ConfidenceScores, CrossLayerImport, DetectorCheck, DiagnosisComparison (+33 more)
...
Cohesion: 0.13
Nodes (25): ORDER, capConfidence(), computeConfidence(), ratio(), WEIGHTS, buildUserPrompt(), reviewPatch(), buildUserPrompt() (+17 more)
...
Cohesion: 0.07
Nodes (21): adapter, CEREBRAS_MODELS, cerebrasAdapter, cerebrasEntry, cerebrasMock, connected, cRt, dead (+13 more)
...
Cohesion: 0.16
Nodes (19): condensation(), CycleDetail, GraphEdge, longestPathDag(), similarityScore(), stronglyConnectedComponents(), tokenize(), Evidence (+11 more)
...
Cohesion: 0.07
Nodes (36): ActiveProvider, getConnectedProviders(), getCredential(), getFingerprint(), getProvider(), isProviderConnected(), listProviders(), ProviderAdapterFactory (+28 more)
...
Cohesion: 0.12
Nodes (19): DagNode, MissionGoal, MissionRecord, MissionTask, MissionTaskRun, Tab, TABS, EXECUTION_STATUS_ICON (+11 more)

### Community 109 - "Community 109"
Cohesion: 0.08
Nodes (26): buildLayerStack(), CONTAINER, Edge, extractArchitectureLayers(), GraphJson, GraphLink, GraphNode, itemsFor() (+18 more)
...
Cohesion: 0.23
Nodes (7): DEP_EDGES, FullStackSearch, EntityHit, QueryIntent, RelationKind, RelationPath, SystemQuery

### Community 112 - "Community 112"
Cohesion: 0.14
Nodes (20): AuditScope, AuditSnapshot, loadPreviousSnapshot(), persistSnapshot(), snapshotDir(), snapshotFile(), summarizeAudit(), TopRisk (+12 more)
...
Cohesion: 0.11
Nodes (12): ANTHROPIC_MODELS, AnthropicAdapter, GeminiAdapter, PersistedStore, ConnectedProvider, ActiveRuntime, DiscoveredModel, ProviderAdapter (+4 more)
...
Cohesion: 0.08
Nodes (16): emptyStatus(), MountTarget, NO_PROVIDER, normalize(), NormalizedError, PipelineManager, ProviderStatus, StreamEmit (+8 more)
...
Cohesion: 0.21
Nodes (4): FILE(), keywords(), ProjectMemory, STOP
...
Cohesion: 0.13
Nodes (10): ConvMessage, FILE(), genId(), ProjectConversations, buildKnowledgeGraph(), ENTITY_TYPE, GraphEdge, GraphNode (+2 more)
...
Cohesion: 0.13
Nodes (20): ArchitectureFindingType, ArchitectureMetrics, ArchitectureThresholds, DEFAULT_THRESHOLDS, ENTRY_PATTERNS, findingId(), isEntryPoint(), LayerRule (+12 more)
...
Cohesion: 0.23
Nodes (21): defaultLayerRules(), getArchitectureHealth(), layerOf(), getEngineeringAudit(), findPackages(), scanWorkspace(), countToPart(), getTechnicalDebt() (+13 more)
...
Cohesion: 0.05
Nodes (40): defaultLayout(), DetailFocus, hydrateLayouts(), hydratePresets(), LayoutLeaf, LayoutNode, LayoutSplit, LayoutState (+32 more)
...
Cohesion: 0.04
Nodes (67): missionClient, MissionDashboard, MissionSummary, EXEC_FILTERS, MissionControl(), MissionDetail(), CATEGORY_LABEL, CATEGORY_TONE (+59 more)
...
Cohesion: 0.18
Nodes (8): CodingEngineOptions, KIND_CATEGORY, IgnoreRules, CodingIndexer, IgnoreConfig, IndexDelta, IndexOptions, IndexStats
...
Cohesion: 0.18
Nodes (15): ExtractedIntent, GoalGraph, IntentClassification, MissionEvent, MissionReviewVerdict, MissionSignals, MissionStrategy, QualityScore (+7 more)
...
Cohesion: 0.21
Nodes (14): git(), gitBlame(), gitHistory(), resolveInsideProject(), compilerDiagnostics(), findTestPaths(), gatherSignals(), nearestSymbol() (+6 more)
...
Cohesion: 0.05
Nodes (59): AddProjectDialog(), Button, useToast(), useWorkspace, hasUnsavedWorkFor(), EngineeringGovernanceDashboard(), useHotkey(), useLayoutStore (+51 more)

## Knowledge Gaps
- **1129 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+1124 more)
...
- **Why does `FullStackKnowledgeEngine` connect `App Shell & Store` to `Community 135`, `Project Profile`, `Gemini Runtime`, `Community 111`, `Community 21`, `Community 119`, `healthEngine.ts`, `Community 156`, `Community 126`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `EngineeringScorecard` connect `Community 90` to `Community 129`, `Community 135`, `Community 79`, `Community 112`, `Community 189`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `runStream()` connect `FullStack Engine & Indexer` to `Community 118`?**
...
- **Should `Project Workspace Sections` be split into smaller, more focused modules?**
  _Cohesion score 0.06946778711484594 - nodes in this community are weakly interconnected._
