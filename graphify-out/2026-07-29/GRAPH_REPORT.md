# Graph Report - aura-hub  (2026-07-29)

## Corpus Check
- 269 files · ~292,343 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2184 nodes · 5219 edges · 116 communities (105 shown, 11 thin omitted)
...
8. `PipelineManager` - 38 edges
9. `useAppStore` - 36 edges
10. `IconName` - 35 edges
...
Cohesion: 0.15
Nodes (19): ActionKind, buildSystemPrompt(), buildUserPrompt(), CodeActionFinding, CodeActionRequest, CodeActionResponse, CodeRelationRef, handleCodeAction() (+11 more)

### Community 1 - "Project Workspace Sections"
Cohesion: 0.12
Nodes (28): Badge(), Card, CardHeader(), EmptyState(), Block(), SectionView(), StatTile(), toneBg (+20 more)

### Community 2 - "Conversations & Intent"
Cohesion: 0.09
Nodes (21): Attachment, Citation, ContextKind, ContextSource, FinishReason, GenerationParams, IntelligenceContext, IntelligenceResponse (+13 more)
...
Cohesion: 0.07
Nodes (22): AiSettings, ConnectedProvider, HealthResult, ProviderStatus, AiSettings(), DialogState, EMPTY_DIALOG, providerIcon() (+14 more)

### Community 7 - "App Shell & Store"
Cohesion: 0.06
Nodes (53): aiClient, ArchitectureLayer, CodeActionFinding, CodeActionRequest, Conversation, ConvMessage, ENV, FieldSpec (+45 more)
...
Cohesion: 0.14
Nodes (24): AiWorkspace(), useWorkspace, useHotkey(), useMediaQuery(), ProjectWorkspace(), Home(), Projects(), renderScreen() (+16 more)
...
Cohesion: 0.09
Nodes (17): ConversationSummary, InspectResult, StreamDone, StreamError, AiMarkdown(), inline(), errorTitle(), Kv() (+9 more)
...
Cohesion: 0.08
Nodes (44): CANDIDATE_EXTS, collectSignals(), computeFingerprint(), detectArchitectureStyle(), detectBuildSystem(), detectEntryPoints(), detectModules(), detectPlatforms() (+36 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (64): ActionKind, CodeActionResponse, CodeRelationRef, GraphEntity, RiskLevel, ACTION_SPECS, actionSpec, AIActionDialog() (+56 more)
...
Cohesion: 0.32
Nodes (11): ANTHROPIC_MODELS, ModelCapabilities, GenerateRequest, GenerateResponse, HealthStatus, HealthStatusType, ModelInfo, RuntimeConfig (+3 more)
...
Cohesion: 0.08
Nodes (34): ActiveProvider, ConnectedProvider, getConnectedProviders(), getCredential(), getFingerprint(), getProvider(), isProviderConnected(), listProviders() (+26 more)

### Community 34 - "Project Memory & Graph"
Cohesion: 0.04
Nodes (82): AuraLockup(), AuraLogo(), AuraLogoProps, AuraTile(), BadgeProps, TONES, ButtonProps, ButtonSize (+74 more)
...
Cohesion: 0.10
Nodes (12): AnthropicAdapter, GeminiAdapter, PersistedStore, DetectionStrategy, KEY_PREFIX_RULES, ActiveRuntime, DiscoveredModel, ProviderAdapter (+4 more)

### Community 38 - "PipelineManager"
Cohesion: 0.17
Nodes (17): ArchitectureExtractor, isMarkdown(), BackendExtractor, isBackendCandidate(), referencedClasses(), versionOf(), entityId(), EntitySpec (+9 more)
...
Cohesion: 0.26
Nodes (9): runStream(), dir(), fileOf(), now(), sanitize(), WorkflowStore, genId(), Workflow (+1 more)
...
Cohesion: 0.13
Nodes (11): normPath(), RelationLinker, FullStackEngineOptions, FullStackKnowledgeEngine, LAYER_CATEGORY, abortError(), AnalyzeOptions, FullStackIndexer (+3 more)
...
Cohesion: 0.12
Nodes (26): buildGlossary(), extractModuleNames(), GLOSSARY_FILE(), guessDefinition(), loadGlossary(), GlossaryEntry, countSourceModules(), generateSummary() (+18 more)
...
Cohesion: 0.11
Nodes (24): DB_DEPS, DIR_WEIGHT, FRAMEWORK_DEPS, IGNORE_DIRS, LANG_BY_EXT, buildModuleDescription(), extractCapabilities(), extractFileDescription() (+16 more)
...
Cohesion: 0.14
Nodes (8): buildKnowledgeGraph(), ENTITY_TYPE, GraphEdge, GraphNode, KnowledgeGraph, LAYER_GROUP, keywords(), ProjectMemory

### Community 101 - "Community 101"
Cohesion: 0.17
Nodes (11): List(), ListItem(), ListItemProps, ListProps, boot, breathe, enterSpaceVariants, leaveSpaceVariants (+3 more)
...
Cohesion: 0.28
Nodes (8): findGraphify(), genState, GraphifyBin, graphifyGraphPath(), graphifyJsonPath(), GraphifyPhase, graphifyStatus(), runGraphify()
...
Cohesion: 0.28
Nodes (10): IntentClassifier, KeywordIntentClassifier, PromptEnhancer, TemplatePromptEnhancer, createRequest(), genId(), EnhancedPrompt, IntelligenceRequest (+2 more)

## Knowledge Gaps
- **540 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+535 more)
...
- **Why does `runStream()` connect `store.ts` to `AI Chat Workspace`?**
  _High betweenness centrality (0.174) - this node is a cross-community bridge._
- **Why does `byKind()` connect `Project Workspace Sections` to `Community 97`, `index.ts`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `FullStackKnowledgeEngine` connect `index.ts` to `Community 98`, `Community 100`, `PipelineManager`, `Community 104`, `Community 105`, `Workspace Manager & Records`, `Intelligence Types`?**
