# Graph Report - aura-hub  (2026-07-26)

## Corpus Check
- 224 files · ~111,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1917 nodes · 4651 edges · 98 communities (86 shown, 12 thin omitted)
...
- [[_COMMUNITY_package.json|package.json]]
- [[_COMMUNITY_ProjectRegistry|ProjectRegistry]]
...
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_OpenAICompatibleRuntime|OpenAICompatibleRuntime]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
- [[_COMMUNITY_detector.ts|detector.ts]]
- [[_COMMUNITY_AnthropicRuntime|AnthropicRuntime]]
- [[_COMMUNITY_compilerOptions|compilerOptions]]
...
1. `cn()` - 73 edges
2. `WorkspaceManager` - 41 edges
3. `Entity` - 40 edges
4. `readJsonFile()` - 39 edges
5. `writeJsonFile()` - 38 edges
6. `Icon` - 38 edges
7. `homePath()` - 37 edges
...
Cohesion: 0.04
Nodes (77): BadgeProps, TONES, ButtonProps, ButtonSize, ButtonVariant, SIZES, VARIANTS, CardProps (+69 more)

### Community 1 - "Project Workspace Sections"
Cohesion: 0.09
Nodes (38): Badge(), Card, CardHeader(), EmptyState(), Graph3DNode, GraphCanvas3D(), liveContainers, GraphCanvas() (+30 more)
...
Cohesion: 0.12
Nodes (27): buildCrossRepoGraph(), CROSS_REPO_FILE, CrossRepoEdge, CrossRepoGraph, detectLanguageClusters(), detectMonorepoCluster(), detectSharedCode(), findPath() (+19 more)

### Community 6 - "AI Client & Settings UI"
Cohesion: 0.06
Nodes (52): Conversation, ConvMessage, ENV, FieldSpec, FolderNode, GraphEntity, GraphRelation, GraphView (+44 more)

### Community 7 - "App Shell & Store"
Cohesion: 0.29
Nodes (6): boot, breathe, enterSpaceVariants, leaveSpaceVariants, pressable, staggerContainer
...
Cohesion: 0.13
Nodes (7): Conversation, ConversationSummary, IndexStatus, ProjectRecord, OpenResult, WorkspaceManager, RunEvent

### Community 10 - "Home & Projects Screens"
Cohesion: 0.09
Nodes (34): HealthResult, ProviderStatus, AiWorkspace(), AuraLockup(), AuraLogo(), AuraLogoProps, AuraTile(), IconButton (+26 more)
...
Cohesion: 0.19
Nodes (16): assessArchitecture(), assessDependencies(), assessDocumentation(), assessTesting(), findOrphanModules(), generateRepositoryHealth(), HEALTH_FILE(), loadRepositoryHealth() (+8 more)
...
Cohesion: 0.08
Nodes (19): aiClient, ConversationSummary, InspectResult, StreamDone, StreamError, AiMarkdown(), inline(), errorTitle() (+11 more)

### Community 15 - "FullStack Entities"
Cohesion: 0.05
Nodes (46): ArchitectureExtractor, isMarkdown(), BackendExtractor, isBackendCandidate(), referencedClasses(), versionOf(), ConfigExtractor, DatabaseExtractor (+38 more)
...
Cohesion: 0.09
Nodes (21): AiSettings, ConnectedProvider, ProviderInfo, AiSettings(), DialogState, EMPTY_DIALOG, providerIcon(), Toggle() (+13 more)
...
Cohesion: 0.12
Nodes (28): CANDIDATE_EXTS, collectSignals(), computeFingerprint(), detectArchitectureStyle(), detectBuildSystem(), detectEntryPoints(), detectModules(), detectPlatforms() (+20 more)

### Community 21 - "Coding Engine & Ignore Rules"
Cohesion: 0.15
Nodes (4): keywords(), MemoryItem, MemoryKind, ProjectMemory
...
Cohesion: 0.17
Nodes (21): DEFAULT_STORE, deriveKey(), getActive(), getAllProviderStores(), getConnectedIds(), getFingerprint(), getHealth(), getKey() (+13 more)
...
Cohesion: 0.20
Nodes (7): HealthStatus, HealthStatusType, ModelInfo, RuntimeConfig, RuntimeMessage, RuntimeToolSpec, StreamChunk
...
Cohesion: 0.14
Nodes (17): abortError(), chunkDocument(), ChunkOptions, extractSymbols(), Accum, buildDocument(), CodingIndexer, throwIfAborted() (+9 more)
...
Cohesion: 0.29
Nodes (10): buildModuleDescription(), extractCapabilities(), extractFileDescription(), FileSummary, generateRepositorySummary(), loadRepositorySummary(), summarizeFile(), summarizeModule() (+2 more)
...
Cohesion: 0.17
Nodes (11): ANTHROPIC_MODELS, AnthropicAdapter, PersistedStore, DiscoveredModel, ModelCapabilities, ProviderAdapter, ProviderHealth, ProviderMetadata (+3 more)
...
Cohesion: 0.31
Nodes (4): FullStackEngineOptions, IgnoreRules, abortError(), FullStackIndexer
...
Cohesion: 0.30
Nodes (7): fileOf(), now(), sanitize(), WorkflowStore, genId(), Workflow, WorkflowSummary
...
Cohesion: 0.09
Nodes (15): DB_DEPS, DIR_WEIGHT, FRAMEWORK_DEPS, IGNORE_DIRS, LANG_BY_EXT, buildGlossary(), extractModuleNames(), GLOSSARY_FILE() (+7 more)

### Community 59 - "healthEngine.ts"
Cohesion: 0.10
Nodes (25): loadCrossRepoGraph(), countSourceModules(), generateSummary(), generateVerificationReport(), loadVerificationReport(), REPORT_FILE(), VerificationSection, verifyArchitecture() (+17 more)
...
Cohesion: 0.29
Nodes (6): buildKnowledgeGraph(), ENTITY_TYPE, GraphEdge, GraphNode, KnowledgeGraph, LAYER_GROUP
...
Cohesion: 0.17
Nodes (10): detectChanges(), FileIndexState, hasChanges(), INDEX_STATE_FILE, IndexResult, LazyFileLoader, loadIndexState(), saveIndexState() (+2 more)
...
## Knowledge Gaps
- **442 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+437 more)
...
- **Why does `FullStackKnowledgeEngine` connect `FullStack Entities` to `ProjectGraphStore`, `Intelligence Types`, `Project Profile`, `performance.ts`?**
...
- **Should `Design System & Core Primitives` be split into smaller, more focused modules?**
  _Cohesion score 0.04184704184704185 - nodes in this community are weakly interconnected._
