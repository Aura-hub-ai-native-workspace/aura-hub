# Graph Report - aura-hub  (2026-07-31)

## Corpus Check
- 413 files · ~399,487 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3675 nodes · 9110 edges · 162 communities (154 shown, 8 thin omitted)
...
1. `cn()` - 93 edges
2. `WorkspaceManager` - 75 edges
3. `Icon` - 74 edges
4. `ProjectId` - 67 edges
5. `useWorkspace` - 61 edges
6. `MissionRecord` - 49 edges
7. `PipelineManager` - 48 edges
8. `IconName` - 48 edges
9. `readJsonFile()` - 47 edges
10. `useAppStore` - 47 edges
...
- `AuraLockup()` --calls--> `cn()`  [EXTRACTED]
  apps/desktop/src/brand/AuraLogo.tsx → packages/core/src/utils/cn.ts
- `ResizablePane()` --calls--> `cn()`  [EXTRACTED]
...
- `Tab()` --calls--> `cn()`  [EXTRACTED]
  apps/desktop/src/ops/PanelWorkspace.tsx → packages/core/src/utils/cn.ts
...
## Communities (162 total, 8 thin omitted)
...
Cohesion: 0.06
Nodes (51): KGNode, RetrieveResult, ArchitectureDiagram3D(), DEFAULT_LAYERS, LayerDef, Card, CardHeader(), EmptyState() (+43 more)

### Community 2 - "Conversations & Intent"
Cohesion: 0.08
Nodes (31): IntentClassifier, KeywordIntentClassifier, PromptEnhancer, TemplatePromptEnhancer, createRequest(), genId(), Attachment, Citation (+23 more)

### Community 3 - "Repository Intelligence Modules"
Cohesion: 0.08
Nodes (54): FileContent, fileExists(), getDirectoryTree(), getFileInfo(), getProjectInfo(), listFiles(), ProjectInfo, readFile() (+46 more)
...
Cohesion: 0.09
Nodes (25): diagnosisClient, missionClient, Badge(), VirtualList(), Icon, CATEGORY_LABEL, EXECUTION_STATUS_TONE, relTime() (+17 more)

### Community 7 - "App Shell & Store"
Cohesion: 0.05
Nodes (49): aiClient, AiSettings, CodeActionFinding, CodeActionRequest, ConnectedProvider, Conversation, ConversationSummary, ConvMessage (+41 more)

### Community 8 - "Workflow Engine"
Cohesion: 0.26
Nodes (8): abortError(), Accum, throwIfAborted(), ScanResult, WorkspaceScanner, FileError, ProgressCallback, ScanEntry

### Community 9 - "Workspace Manager & Records"
Cohesion: 0.07
Nodes (11): DiagnosisEvent, DiagnosisRequest, PatchCandidate, MissionEvent, MemoryItem, MemoryKind, IndexStatus, ProjectRecord (+3 more)

### Community 10 - "Home & Projects Screens"
Cohesion: 0.08
Nodes (32): useHotkey(), useMediaQuery(), defaultLayout(), DetailFocus, hydrateLayouts(), hydratePresets(), LayoutLeaf, LayoutNode (+24 more)
...
Cohesion: 0.26
Nodes (5): MissionExecution, fileOf(), hydrate(), MissionStore, MissionSummary
...
Cohesion: 0.22
Nodes (10): ConfigExtractor, DatabaseExtractor, isPrisma(), isSql(), isTsOrm(), LineMap, makeEntity(), snippetAround() (+2 more)
...
Cohesion: 0.10
Nodes (32): CANDIDATE_EXTS, collectSignals(), computeFingerprint(), detectArchitectureStyle(), detectBuildSystem(), detectEntryPoints(), detectModules(), detectPlatforms() (+24 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (66): ActionKind, CodeActionResponse, GraphEntity, RiskLevel, ACTION_SPECS, actionSpec, WorkspaceActionId, AIActionDialog() (+58 more)

### Community 22 - "TypeScript Config"
Cohesion: 0.07
Nodes (29): compilerOptions, allowImportingTsExtensions, baseUrl, esModuleInterop, forceConsistentCasingInFileNames, isolatedModules, jsx, lib (+21 more)
...
Cohesion: 0.12
Nodes (28): DEFAULT_STORE, deriveKey(), getActive(), getAllProviderStores(), getConnectedIds(), getFingerprint(), getHealth(), getKey() (+20 more)
...
Cohesion: 0.13
Nodes (24): Mount, buildProfile(), classify(), DB_DEPS, deriveBuildSystem(), deriveCodingStyle(), deriveEntryPoints(), deriveImportantFiles() (+16 more)

### Community 28 - "Gemini Runtime"
Cohesion: 0.25
Nodes (10): ModelCapabilities, GenerateRequest, GenerateResponse, HealthStatus, HealthStatusType, ModelInfo, RuntimeConfig, RuntimeMessage (+2 more)
...
Cohesion: 0.07
Nodes (44): HealthIssue, HealthScore, scanSecurityFindings(), scanTechnicalDebt(), SECRET_PATTERNS, summarizeDependencies(), gatherGitStatus(), gatherRecentCommits() (+36 more)

### Community 33 - "Pipeline & Server"
Cohesion: 0.07
Nodes (38): ActiveProvider, getConnectedProviders(), getCredential(), getFingerprint(), getProvider(), isProviderConnected(), listProviders(), ProviderAdapterFactory (+30 more)

### Community 34 - "Project Memory & Graph"
Cohesion: 0.04
Nodes (83): MissionDashboard, MissionSummary, BadgeProps, TONES, ButtonProps, ButtonSize, ButtonVariant, SIZES (+75 more)
...
Cohesion: 0.08
Nodes (32): FieldSpec, NodeRunState, NodeSpecInfo, WfEdge, WfNode, WfRunEvent, Workflow, WorkflowSummary (+24 more)
...
Cohesion: 0.08
Nodes (41): CHECKPOINT_LABELS, CHECKPOINT_ORDER, checkpointStatus(), emptyCheckpoints(), nextCheckpoint(), statusFromCheckpoints(), DagInput, DEP_WEIGHT (+33 more)

### Community 41 - "ProjectGraphStore"
Cohesion: 0.18
Nodes (20): CallSite, detectBrokenApi(), findCallSites(), findRealCallers(), detectDeadCode(), NEVER_ELIGIBLE_KINDS, ORDER, scanExports() (+12 more)
...
Cohesion: 0.19
Nodes (11): ContextBuilder, CodingContext, CodingContextEntry, ContextChunkRef, ContextOptions, IndexPhase, MatchMode, Progress (+3 more)
...
Cohesion: 0.05
Nodes (50): AuraLockup(), AuraLogo(), AuraLogoProps, AuraTile(), AddProjectDialog(), Button, Dialog(), useWorkspace (+42 more)

### Community 52 - "verification.ts"
Cohesion: 0.19
Nodes (16): WEIGHTS, buildUserPrompt(), reviewPatch(), BugCategory, Classification, CompilerDiagnostic, ConfidenceScores, DetectorCheck (+8 more)
...
Cohesion: 0.23
Nodes (12): detectNullBug(), findEnclosingFunction(), isNullableTypeText(), NULLABLE_CALL_NAMES, offsetForLine(), collectDeclaredNames(), DeclaredName, isFunctionLike() (+4 more)
...
Cohesion: 0.09
Nodes (29): DiagnosisStore, dir(), fileOf(), DiagnosisRecord, DiagnosisSummary, CodeStyle, CommunicationStyle, detectCodeStyle() (+21 more)
...
Cohesion: 0.08
Nodes (33): ProviderInfo, IconName, ApiKeyInput(), KeyStatus, detectProviderId(), RULES, ProviderCard(), ProviderCardProps (+25 more)
...
Cohesion: 0.25
Nodes (7): Checklist, Files Changed, Problem, Screenshots, Solution, Summary, Testing
...
Cohesion: 0.09
Nodes (37): ArchitectureFinding, defaultLayerRules(), layerOf(), parseImportSpecifiers(), Evidence, Finding, ScorePart, Severity (+29 more)
...
Cohesion: 0.12
Nodes (24): DB_DEPS, DIR_WEIGHT, FRAMEWORK_DEPS, LANG_BY_EXT, assessArchitecture(), assessDependencies(), assessDocumentation(), assessTesting() (+16 more)

### Community 90 - "Community 90"
Cohesion: 0.09
Nodes (25): governanceClient, CacheEntry, createGovernanceEngine(), GovernanceEngine, GovernanceEngineOptions, ReportName, ArchitectureHealthReport, ArchitectureInput (+17 more)
...
Cohesion: 0.12
Nodes (28): EngineeringMemory, EngineeringMemoryRecord, MemoryEvent, MemoryEventListener, MemoryFilter, MemoryIndex, MemoryIndexEntry, MemoryMetadata (+20 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (6): memoryGraph, EngineeringInsights, PatternEngine, PatternStore, PredictionFoundation, EngineeringSearch
...
Cohesion: 0.12
Nodes (25): toScore100(), analyzeCodeShape(), ClassShape, CodeShape, complexityStats, FunctionShape, lineDepthDelta(), matchFunctionStart() (+17 more)
...
Cohesion: 0.07
Nodes (29): buildLayerStack(), CONTAINER, Edge, extractArchitectureLayers(), GraphJson, GraphLink, GraphNode, itemsFor() (+21 more)

### Community 104 - "Community 104"
Cohesion: 0.11
Nodes (22): CheckpointStatus, ExecutionDag, ExecutionTaskStatus, MissionReplayPayload, TaskKind, TaskPriority, TaskRisk, TaskStatus (+14 more)

### Community 105 - "Community 105"
Cohesion: 0.15
Nodes (9): CodingEngineOptions, CodingKnowledgeEngine, KIND_CATEGORY, IgnoreRules, CodingIndexer, IgnoreConfig, IndexDelta, IndexOptions (+1 more)
...
Cohesion: 0.13
Nodes (25): classify(), capConfidence(), computeConfidence(), ratio(), buildUserPrompt(), compareCandidates(), now(), runDiagnosis() (+17 more)
...
Cohesion: 0.10
Nodes (11): ANTHROPIC_MODELS, AnthropicAdapter, classifyError(), GeminiAdapter, ConnectedProvider, ActiveRuntime, ProviderAdapter, ProviderHealth (+3 more)

### Community 112 - "Community 112"
Cohesion: 0.15
Nodes (22): AuditSnapshot, getEngineeringAudit(), loadPreviousSnapshot(), persistSnapshot(), snapshotDir(), snapshotFile(), summarizeAudit(), TopRisk (+14 more)

### Community 113 - "Community 113"
Cohesion: 0.40
Nodes (5): Branch Protection — `main`, Current configuration, How to configure this in the GitHub UI, How to configure via `gh` / REST API, Note on GitHub plan limits
...
Cohesion: 0.20
Nodes (15): git(), gitBlame(), gitHistory(), compilerDiagnostics(), findTestPaths(), GatherResult, gatherSignals(), nearestSymbol() (+7 more)

### Community 116 - "Community 116"
Cohesion: 0.29
Nodes (11): detectArchitectureSmell(), DISALLOWED, fileLayerMap(), resolveCrossLayerImports(), countImportLines(), ImportedName, scanImportSpecifiers(), evaluatePatchLimiter() (+3 more)
...
Cohesion: 0.12
Nodes (5): emptyStatus(), normalize(), PipelineManager, AiSettings, ConversationTurn

### Community 120 - "Community 120"
Cohesion: 0.16
Nodes (11): IGNORE_DIRS, detectChanges(), FileIndexState, hasChanges(), INDEX_STATE_FILE, IndexResult, LazyFileLoader, loadIndexState() (+3 more)

### Community 121 - "Community 121"
Cohesion: 0.29
Nodes (7): setCheckpoint(), buildDag(), activity(), MissionExecutionEngine, timeline(), computeMetrics(), MissionRecord
...
Cohesion: 0.14
Nodes (16): DagNode, MissionGoal, MissionRecord, MissionTask, MissionTaskRun, MissionDetail(), Tab, TABS (+8 more)

### Community 124 - "Community 124"
Cohesion: 0.18
Nodes (14): MISSION_DIR(), MISSION_FILE(), MissionMemory, PATTERN_DIR(), MissionMemoryRecord, OutcomeType, TimelineEvent, ProjectTimeline (+6 more)
...
Cohesion: 0.09
Nodes (12): Conversation, ConversationSummary, ConvMessage, FILE(), genId(), ProjectConversations, buildKnowledgeGraph(), ENTITY_TYPE (+4 more)

### Community 127 - "Community 127"
Cohesion: 0.13
Nodes (19): buildModuleGraph(), CODE_EXTS, GraphBuildOptions, hasFile(), INDEX_FILES, matchPackageName(), ModuleGraph, ModuleNode (+11 more)
...
Cohesion: 0.11
Nodes (26): ArchitectureFindingType, ArchitectureMetrics, ArchitectureThresholds, DEFAULT_THRESHOLDS, ENTRY_PATTERNS, findingId(), getArchitectureHealth(), isEntryPoint() (+18 more)

### Community 130 - "Community 130"
Cohesion: 0.20
Nodes (4): MEMORY_DIR(), MEMORY_FILE(), MemoryStore, BaseMemoryRecord
...
Cohesion: 0.14
Nodes (18): DagNode, AUTOMATION_LEVELS, buildSystemPrompt(), buildUserPrompt(), generateGoalGraph(), GOAL_PRIORITIES, renderEvidence(), renderIntent() (+10 more)

### Community 133 - "Community 133"
Cohesion: 0.19
Nodes (10): MemoryGraphBuilder, generateBugId(), generateDecisionId(), generateGraphEdgeId(), generateGraphNodeId(), generateId(), generateMemoryId(), generatePatternId() (+2 more)
...
Cohesion: 0.19
Nodes (15): findPackages(), isSourcePath(), isTestPath(), PackageInfo, ScannedWorkspace, scanWorkspace(), SOURCE_EXTS, TEST_MARKERS (+7 more)
...
Cohesion: 0.12
Nodes (14): PanelKind, DiagnosticsPanel, DocsPanel, FeedPanel, FilesPanel, KnowledgePanel, MemoryPanel, MissionDetailPanel (+6 more)
...
Cohesion: 0.30
Nodes (7): dir(), fileOf(), now(), sanitize(), WorkflowStore, Workflow, WorkflowSummary
...
Cohesion: 0.14
Nodes (26): classifyMissionIntent(), emptyRecord(), now(), runMissionCreation(), capUnit(), computeArchitectureAwareness(), computeIntentUnderstanding(), computeKnowledgeUsage() (+18 more)

### Community 143 - "Community 143"
Cohesion: 0.15
Nodes (12): ActivityEntry, TimelineEntry, TimelineType, ActivityFeed(), ACTOR_COLOR, TYPE_ICON, CHECKPOINT_LABEL, fmtClock() (+4 more)

### Community 144 - "Community 144"
Cohesion: 0.33
Nodes (11): analyzeMissionRisk(), ARCHITECTURE_FOCUS_KEYWORDS, capUnit(), collectUnknowns(), computeArchitectureRisk(), computeComplexity(), computeConfidence(), computeDependencyRisk() (+3 more)
...
Cohesion: 0.43
Nodes (6): resolveInsideProject(), generateTaskProposal(), languageForPath(), TaskGenResult, MissionGoal, TaskProposal
...
Cohesion: 0.36
Nodes (5): DECISION_DIR(), DECISION_FILE(), DecisionMemory, DecisionAlternative, DecisionRecord
...
Cohesion: 0.22
Nodes (7): MissionCategory, EXEC_FILTERS, MissionControl(), STAGE_LABEL, CATEGORY_TONE, useMissions(), MissionDetailPanel()
...
Cohesion: 0.18
Nodes (4): DEFAULT_RULES, validateArchitecture(), ValidationViolation, ValidationWarning
...
Cohesion: 0.29
Nodes (6): CheckpointState, ExecutionStatus, MissionApproval, CheckpointPanel(), CP_COLOR, CP_ICON

## Knowledge Gaps
- **950 isolated node(s):** `name`, `version`, `private`, `type`, `description` (+945 more)
...
- **Why does `FullStackKnowledgeEngine` connect `Community 96` to `Community 101`, `Community 105`, `Intelligence Types`, `Community 117`, `Community 118`, `Project Profile`, `Community 125`, `Community 126`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `EngineeringScorecard` connect `Community 90` to `Community 112`, `Community 101`, `Community 79`?**
  _High betweenness centrality (0.082) - this node is a cross-community bridge._
- **Why does `Icon` connect `AI Client & Settings UI` to `Community 160`, `Project Workspace Sections`, `Project Memory & Graph`, `anthropic.ts`, `Community 70`, `App Shell & Store`, `Community 104`, `Home & Projects Screens`, `Community 143`, `personality.ts`, `Community 21`, `Community 152`, `Community 90`, `Community 123`, `Community 92`, `performance.ts`?**
