...
export class KimiAdapter extends BaseOpenAICompatible {
  readonly metadata = { id: 'kimi', name: 'Kimi', description: 'Moonshot AI models', docsUrl: 'https://platform.moonshot.cn/console/api-keys' };
  ...
  createRuntime(apiKey: string, model?: string): Runtime {
    return this.makeRuntime({ baseUrl: this.baseUrl, apiKey, defaultModel: model || 'kimi-latest' });
  }
}
