...
export class GroqAdapter extends BaseOpenAICompatible {
  readonly metadata = { id: 'groq', name: 'Groq', description: 'Fast inference cloud (free tier available)', docsUrl: 'https://console.groq.com/keys', defaultModel: 'llama-3.3-70b-versatile' };
